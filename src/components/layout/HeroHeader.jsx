...
const HeroHeader = () => {
  return (
    <div className="w-[100vw] h-[100dvh]">
      <img
        src="/public/drawables/cloud_bg-1.jpg"
        alt="cloud_illustration"
        className="w-full h-full bg-center bg-cover !object-cover !object-center"
      />

      <div className="w-[80%] h-[80%] bg-white bg-opacity-30 p-16 rounded-md flex flex-col gap-10 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] backdrop-filter backdrop-blur-sm border border-white border-opacity-20 ">
        <div className="flex justify-between items-center">
          <span className="font-semibold text-xl">Shubhangi</span>
        ...
        <span>
          <h1 className="text-stone-700 text-5xl font-semibold font-serif w-[56%] mt-24">
            Hi I am Shubhangi 👋
          </h1>
        </span>

        <span>
          <p className="text-stone-700 text-lg w-[56%]">
        ...
        <button className="w-fit text-lg px-16 py-3 bg-stone-700 text-stone-100 rounded-lg flex justify-between items-center space-x-2 font-semibold">
          Say Hello{" "}
